...
{
    internal class StartupClassGenerator
    {
...
{{
    ...
    {{
        ...
        {{
            ...
            {(options.EnableWebApi == false ? "" : "System.IdentityModel.Tokens.Jwt.JwtSecurityTokenHandler.DefaultInboundClaimTypeMap.Clear();")}
        }}
