...
namespace Rixian.Extensions.AspNetCore.Generators
{
    ...
    public class Generators : ISourceGenerator
    {
        ...
        class ExtraFileOptions
        {
            public bool DataProtectionConfig { get; set; }
            public bool KeyRingConfig { get; set; }
            public bool DataProtectionServiceCollectionExtensions { get; set; }
            public bool ApiConfig { get; set; }
            public bool OAuth2Config { get; set; }
            public bool AuthInfoHelper { get; set; }
            public bool SlugifyParameterTransformer { get; set; }
            public bool SameSiteCookiesServiceCollectionExtensions { get; set; }
            public bool RedisConfig { get; set; }
            public bool OpenIdConnectConfig { get; set; }
        }
